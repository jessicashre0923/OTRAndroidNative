...
import androidCarrierClasses.CardsOverviewSmartfunds;
...
public class SmartFundsCardOverviewRun{
	...
	public void carrierControlTestAndroidLoginLogout() throws Exception {
		...
		try {
			...
			androidLogs.setupTest("SmarfFunds card overview Functional Test on 102698db");
			...
			androidLogs.CapturedLogs(androidText.INFO, "SmarfFunds card overview Functional Test completed");
