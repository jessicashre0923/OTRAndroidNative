...
public class SmartHubLoginTest {
	static AppiumDriver<WebElement> driver;

	@Test
	public void SmartHubLoginTest() throws Exception {
		...
		try {
			...
			System.out.println(phone.autoPhonePickerSmartHub(appName));
