...
public class CreateMoneyCodeBillMeLater {
	...
	public CreateMoneyCodeBillMeLater createMoneyCode() throws Exception {
		androidLogs.setupTest("MoneyCode Bill me later");
...
//			logs.CapturedLogs("Test Pass", "Add Fields Next Button MoneyCode found and clicked");}
			...
			androidLogs.CapturedLogs(androidText.PASS, "Info fields driver Bill me Latert text filled in");
			}else {
			androidLogs.CapturedLogs(androidText.FAIL, "Info fields driver Bill me Latert text Not found");
			}
			
			Thread.sleep(3000);
			WebElement InfoDetailsNotesTextBox = elements.InfoDetailsNotesTextBox();
			Thread.sleep(3000);
			if (InfoDetailsNotesTextBox != null && InfoDetailsNotesTextBox.isEnabled()) {
				InfoDetailsNotesTextBox.sendKeys("Android Mobile Automation");
