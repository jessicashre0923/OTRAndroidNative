...
import androidCardClasses.FindFuelPage;
...
public class FindFuelPageRun {
	...
	public void cardControlTestAndroid() throws Exception {
		...
		FindFuelPage findFuelPage = new FindFuelPage();
...
//TODO THIS IS A WORK IN PROGRESS FindFuel.mapTesting PAGE IS NOT YET STARTED		
		...
		try {
			androidLogs.setupTest("Find Fuel Page Function test");
			System.out.println("Find Fuel Page Function test");
			...
			findFuelPage.FindFuelPage(env, storedAccount, storedPinOrPassword, accountType);
...
//TODO DECIDE IF WE NEED TO TEST ON MORE CARD TYPES OR NOT LEANING TOWARDS NO
//			accountType = "COMPANY";
//			androidLogs.setupTestYellow("LOCATING " + accountType + " ON: " + env);
//			getAccount.CardPassExpected(accountType);
//			storedAccount = getAccount.getAccountNum();
...
//			findFuelPage.FindFuelPage(env, storedAccount, storedPinOrPassword, accountType);
//			logout.logoutCardControl();
//			androidLogs.CapturedLogs(pass, "Logged out of " +accountType+ " Cards");
//			Capabilities.driver.closeApp();
//			Capabilities.driver.quit();
//
//			// UNIVERSAL CARD
...
//			Capabilities.driver.quit();
			...
			androidLogs.CapturedLogs(info, "Find fuel page test completed");
